...
This is a base project for Angular 18 with PrimeNg 12.1.1. to start a new project.
...
To change the theme, you can change the `angular.json` file and change the `styles` array in the `build` and `test` objects.
